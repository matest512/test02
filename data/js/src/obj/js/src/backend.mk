...
DIRS := editline shell jsapi-tests tests gdb build
export:: js-confdefs.h
GARBAGE += js-confdefs.h
EXTRA_MDDEPEND_FILES += js-confdefs.h.pp
js-confdefs.h: /home/hf/Desktop/nnnnn/test/data/python/mozbuild/mozbuild/action/process_define_files.py $(srcdir)/js-confdefs.h.in
	$(REPORT_BUILD)
	$(call py_action,file_generate,/home/hf/Desktop/nnnnn/test/data/python/mozbuild/mozbuild/action/process_define_files.py process_define_file js-confdefs.h $(MDDEPDIR)/js-confdefs.h.pp $(srcdir)/js-confdefs.h.in)

export:: js-config.h
GARBAGE += js-config.h
EXTRA_MDDEPEND_FILES += js-config.h.pp
js-config.h: /home/hf/Desktop/nnnnn/test/data/python/mozbuild/mozbuild/action/process_define_files.py $(srcdir)/js-config.h.in
	$(REPORT_BUILD)
	$(call py_action,file_generate,/home/hf/Desktop/nnnnn/test/data/python/mozbuild/mozbuild/action/process_define_files.py process_define_file js-config.h $(MDDEPDIR)/js-config.h.pp $(srcdir)/js-config.h.in)
...
frontend/ReservedWordsGenerated.h: /home/hf/Desktop/nnnnn/test/data/js/src/frontend/GenerateReservedWords.py $(srcdir)/frontend/ReservedWords.h
	$(REPORT_BUILD)
	$(call py_action,file_generate,/home/hf/Desktop/nnnnn/test/data/js/src/frontend/GenerateReservedWords.py main frontend/ReservedWordsGenerated.h $(MDDEPDIR)/frontend/ReservedWordsGenerated.h.pp $(srcdir)/frontend/ReservedWords.h)
